            ...
            <div class="col-lg-2">
                <div class="d-flex flex-column ps-3 py-3">
                    ...
                    <small>
                        ...
                        <?php echo esc_html($brands_preview_subheader_text); ?>
                    </small>
                </div>
            </div>

            <div class="col-lg-9">
                <div class="p-2 h-100 d-flex align-items-center">
                    <img src="<?php echo esc_url($brands_preview_banner['url']); ?>"
                        alt="<?php echo esc_attr($brands_preview_banner['alt']); ?>"
                        class="img-fluid w-100 brand-preview-img" />
                </div>
            </div>
