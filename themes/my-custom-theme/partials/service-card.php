...
<div class="col-12 d-flex gap-5">
    <div> <?php if (!empty($args['image'])): ?>
        <div class="w-100 mb-3 position-relative service-image-container custom-rounded">
            <div class="service-inner-span d-flex gap-1 w-100 px-2 py-1 text-light fs-5">
                <span class="service-inner-span-text"><?php echo esc_html($args['service_heading']); ?>
                </span>
                <div class="arrow-container">
                    <i class="bi bi-arrow-right-short"></i>
                </div>
            </div>
            <img src="<?php echo esc_url($args['image']); ?>" alt="<?php echo esc_attr($args['service_heading']); ?>"
                class="img-fluid" />
        </div>
        <?php endif; ?>
    </div>
    <div class="w-50">
        ...
        <p class="mt-3 service-description text-grey">
